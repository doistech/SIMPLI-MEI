    ...
    void finishOrderSales() {
        ...
        if(!errorUi.hasError) {
            if (butonMethodPaymentMap.signal.action) {
                ...
                if (sumMethodPaymentOrderSales == truncar(orderSales.totalOrder)) {
                    orderSales.orderStatus = 'Pendente'
                    orderSales.paymentStatus = 'Pago'
                ...
                } else if (sumMethodPaymentOrderSales > truncar(orderSales.totalOrder)) {
